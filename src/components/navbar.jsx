...
const Navbar = () => {
  ...
  return (
    <div className="relative z-50">
      {/* Overlay to block interactions when menu is open */}
      {isMenuOpen && (
        <div
      ...
      <div className="absolute top-0 left-0 right-0 flex justify-between items-center px-4 mr-4 sm:px-6 -mt-5 md:px-10 py-6 md:-mt-12 sm:py-8 lg:py-10 xl:py-12 mb-4 lg:-mt-16 bg-transparent z-50">
        {/* Logo */}
        <Link to="/" className="h-20 sm:h-20 md:h-28 w-auto">
        ...
        <div
          {...bind()}
          className={`fixed top-0 left-0 h-full w-full bg-[#1b1b1b] transform transition-transform duration-300 ease-in-out z-50 md:hidden flex flex-col justify-center items-center ${
